=== Paloma Postman Widget ===
Contributors: PalomaTeknik
Donate link: http://www.paloma.se
...
customer ID and Hash. To receive this information, contact support@paloma.se and ask for the ID
...
support@paloma.se again and ask for help with the issue.
...
there is no issue with your network connection. If the problem persists, contact support@paloma.se.
...
1. The Postman widget on a Wordpress website
